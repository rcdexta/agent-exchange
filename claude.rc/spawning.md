...
Pane launching is included in AX 0.6.1 for Claude Code, Codex CLI, Grok Build, and OpenCode. Start Pi directly with `ax pi -name NAME`; Pi pane spawning is not supported yet.
